  ...
  return (
    ...
    >
      <div className="text-lg font-bold lg:text-xl xl:text-2xl ">
        Wanna work together ? Email me
      </div>
      <div className="mt-8 flex items-center justify-between">
        <Button className="mr-4 rounded-lg bg-c-action p-2 font-bold text-black">
          <a href="mailto: yacine.frhat@gmail.com">Email me</a>
        </Button>
        <Button className="mr-4 rounded-lg bg-c-l-green p-2 font-bold text-black">
